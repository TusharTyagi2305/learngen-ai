  ...
  return (
    <div ref={containerRef} className="bento-section" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px', position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
        <ParticleCard particleCount={4} enableTilt={true} enableMagnetism={true} clickEffect={true} glowColor="16, 185, 129" className="magic-bento-card magic-bento-card--border-glow" style={{ padding: '20px' }}>
        ...
        <ParticleCard particleCount={4} enableTilt={true} enableMagnetism={true} clickEffect={true} glowColor="245, 158, 11" className="magic-bento-card magic-bento-card--border-glow" style={{ padding: '20px' }}>
        ...
        <ParticleCard particleCount={4} enableTilt={true} enableMagnetism={true} clickEffect={true} glowColor="6, 182, 212" className="magic-bento-card magic-bento-card--border-glow" style={{ padding: '20px' }}>
        ...
        <ParticleCard particleCount={4} enableTilt={true} enableMagnetism={true} clickEffect={true} glowColor="59, 130, 246" className="magic-bento-card magic-bento-card--border-glow" style={{ padding: '20px' }}>
      ...
      <div className="grid-responsive-2">
        ...
        <ParticleCard particleCount={8} enableTilt={false} enableMagnetism={false} clickEffect={false} glowColor="6, 182, 212" className="magic-bento-card magic-bento-card--border-glow" style={{ padding: '24px' }}>

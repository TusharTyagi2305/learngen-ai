...
export function DashboardHome() {
  ...
  const dashboardCards = [
    { title: 'AI RAG Studio', description: 'Grounded chat with citations', icon: MessageSquare, route: 'ai-chat', color: '#161120', label: 'Interactive' },
    { title: 'Document Vault', description: `${safeDocs.length} Vector Index Collections`, icon: Database, route: 'documents', color: '#161120', label: 'Storage' },
    { title: 'AI Quiz Engine', description: 'Test concept mastery', icon: HelpCircle, route: 'quiz-generator', color: '#161120', label: 'Assessment' },
    { title: '3D Flashcards', description: 'Spaced repetition decks', icon: Layers, route: 'flashcards', color: '#161120', label: 'Retention' }
  ];
